 ...
 */
class WebPermissionPolicy
{
    /**
     * Determine if the user can perform the action on the model.
     */
    protected function can(User $user, Model|string $model, WebPermissionEnum $permission): Response
    {
        return Gate::allowIf(
     ...
     */
    protected function before(User $user, Model|string $model, WebPermissionEnum $permission): Response
    {
     ...
     */
    protected function after(User $user, Model|string $model, WebPermissionEnum $permission): Response
    {
    ...
    {
        if (! defined(WebPermissionEnum::class.'::'.strtoupper($method))) {
            throw new \BadMethodCallException("Method {$method} does not exist.");
        }

        $permission = constant(WebPermissionEnum::class.'::'.strtoupper($method));
